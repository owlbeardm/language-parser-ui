...
export class EvolutionComponent extends AbstractHasLanguage {
  ...
  // evolveAllWords() {
  //   if (this.selectedLanguage && this.selectedLanguageTo)
  //     this.apiService.postApiLangsEvolveFromTo({ from: this.selectedLanguage, to: this.selectedLanguageTo }).subscribe((i:any) => { console.log(i); this.updateLangTo(); });
  // }
  // reEvolveAllWords() {
  //   if (this.selectedLanguage && this.selectedLanguageTo)
  //     this.apiService.postApiLangsReevolveFromTo({ from: this.selectedLanguage, to: this.selectedLanguageTo }).subscribe((i:any) => { console.log(i); this.updateLangTo(); });
  // }

  evolveWord(wordToEvolve:any) { alert("not implemented") }
  reEvolveWord(wordToEvolve:any) { alert("not implemented") }
